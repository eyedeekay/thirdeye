...
func main() {
	...
	upstream := flag.String("upstream", "http://lxik2bjgdl7462opwmkzkxsx5gvvptjbtl35rawytkndf2z7okqq.b32.i2p/hosts,http://i2p2.i2p/hosts.txt,http://no.i2p/export/alive-hosts.txt", "Fetch more hosts from here")
